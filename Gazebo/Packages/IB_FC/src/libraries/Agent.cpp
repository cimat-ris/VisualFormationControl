...
*/	
IB_FC::geometric_constraint Agent::sendGeometricConstraintMsg(int index){
...
*/
void Agent::getImageDescription(const IB_FC::image_description::ConstPtr& msg){
...
//                            pose,pose_j,
//                             R,t,
//                             processor.pj.at(idx), processor.pi.at(idx));		
//         }else{
//             double p_ij [4];
//     p_ij[0] = controller.pose_j[0] - controller.pose_i[0];
//     p_ij[1] = controller.pose_j[1] - controller.pose_i[1];
//     p_ij[2] = controller.pose_j[2] - controller.pose_i[2];
//     p_ij[3] = controller.pose_j[5] - controller.pose_i[5];
//     cout << "------------- DB2 ------------- \n";
// 	 controller.getError(matches,controller.label,j, p_ij[0], p_ij[1], p_ij[2], p_ij[3]);
//         }
//     }
}
...
*/
void Agent::getGeometricConstraint(const IB_FC::geometric_constraint::ConstPtr& msg){
...
//     if(idx >= 0)
//     {
// 	controller.compute(matches,you,GC,pose,pose_j,R,t,processor.pj.at(idx), processor.pi.at(idx));	
//     }else{
//             double p_ij [4];
//     p_ij[0] = controller.pose_j[0] - controller.pose_i[0];
//     p_ij[1] = controller.pose_j[1] - controller.pose_i[1];
...
//     p_ij[3] = controller.pose_j[5] - controller.pose_i[5];
//     cout << "------------- DB2 ------------- \n";
// 	 controller.getError(matches,controller.label,you, p_ij[0], p_ij[1], p_ij[2], p_ij[3]);
//         }
}
...
/*
	...
	returns:
		IB_FC costumed message to advertise gamma value
*/
IB_FC::gamma Agent::getGamma(){
	IB_FC::gamma g;
	g.gamma = Z;
	g.label = label;
	return g;
...
*/
void Agent::setGamma(const IB_FC::gamma::ConstPtr& msg){
