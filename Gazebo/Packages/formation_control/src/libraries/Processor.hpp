...
/*********************************************************************************** ROS libraries*/
#include <formation_control/image_description.h>
#include <formation_control/key_point.h>
#include <formation_control/descriptors.h>
#include <formation_control/geometric_constraint.h>
...
class Processor{
	...
	public:
		...
		formation_control::image_description getImageDescription();//returns the image description ready to send as msg
		formation_control::geometric_constraint getGM(int index);//to obtain the msg for the corresponding pair
	...
	private:
		...
		formation_control::image_description id; //for image description message
		vector<formation_control::geometric_constraint> gm;//to send homography	made with every neighbor
