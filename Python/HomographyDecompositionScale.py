...
rows = 3
cols = 2
ax,fig = configure_plot(rows,cols,15,20,'Position-based control using Homography Decomposition with scale estimation')
...
ax,fig = plot_quarter(ax,fig,[rows,cols,2],t_arr,gamma,'Scale consensus',ite,None,['Time (s)','Scale'],4)
