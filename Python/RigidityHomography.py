...
#================================================================points in scene
xx = np.array([0.75,1.25,1.25,0.75, 0.5,1.]) #place here the X
yy = np.array([1.25,1.25,0.75,0.75, 0.5,1.]) #place here the y
zz = np.array([-1,-1,-1,-1,-1,-1]) #place here the Z
...
plot_consensus_results(n_cameras,init_cameras,desired_cameras,copy,init_poses,desired_poses,x,y,z,v,w,xx,yy,zz,t_arr,err_t,err_psi,None,legend='Position-based control using Homography Decomposition and Rigidity Matrix')
